...
export const siteCopy = {
  ...
  /** Trust strip below hero — platform ratings (stationary, scroll-reveal) */
  trustBanner: {
  ...
  servicesSpotlight: {
    ...
    title: "Roofing services built for South Florida",
    subtitle:
      "From re-roofs and emergency repairs to maintenance, gutters, and insurance claim support — same Sovereign scheduling and site standards.",
    cta: "View",
    items: [
      {
        category: "Re-Roofs",
        title: "Full roof replacement",
        alt: "Fresh residential re-roof on a South Florida home",
        imageSrc: "/portfolio/project-07-suburban-reroof.png",
      },
      {
        category: "Emergency repairs",
        title: "Leaks, valleys & storm damage",
        alt: "Detailed shingle roof valley used for emergency leak repair service",
        imageSrc: "/portfolio/project-10-valley-shingles.png",
      },
      {
        category: "Maintenance",
        title: "Preventive roof care",
        alt: "Aerial view of South Florida roofs for maintenance planning",
        imageSrc: "/portfolio/project-06-community-overview.png",
      },
      {
        category: "Gutters",
        title: "Gutter installation",
        alt: "South Florida home exterior suited for gutter installation and drainage planning",
        imageSrc: "/portfolio/project-03-mediterranean-estate.png",
      },
      {
        category: "Insurance claims",
        title: "Photo documentation & scope support",
        alt: "Roofing crew preparing documentation and repair support on a jobsite",
        imageSrc: "/service-areas/areas-we-serve-roofing-crew.jpg",
      },
      {
        category: "Specialty systems",
        title: "Tile & metal roofing",
        alt: "Modern metal roof and specialty roofing system on a South Florida home",
        imageSrc: "/portfolio/project-04-metal-roof.png",
      },
    ],
  },
  ...
  about: {
    ...
    credentials:
      "Minority-owned · Licensed & insured · Contractor license CCC1336048 · South Florida",
  ...
  ui: {
    ...
    aboutOnSiteClipsAria: "On-site project videos",
...
export const portfolioCards = [
  {
    ...
    alt: "Completed residential roof installation by Sovereign Roofing in South Florida",
    category: "Residential",
    title: "Finished roof install",
    cta: "View",
    href: contactHref,
  },
  {
    src: "/portfolio/project-02.jpg",
    alt: "Close-up of roof work and materials on a South Florida home",
    category: "Detail",
  ...
  },
  {
    ...
    alt: "Brown concrete tile roof with palm-lined neighborhood in the background",
    category: "Tile",
    title: "Concrete tile roof",
    cta: "View",
    href: contactHref,
  },
  {
    src: "/portfolio/project-05.jpg",
    alt: "On-site photo from a Sovereign Roofing job in South Florida",
    category: "On site",
    title: "Recent job site",
    cta: "View",
    href: contactHref,
  },
];
