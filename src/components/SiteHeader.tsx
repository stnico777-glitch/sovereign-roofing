...
export function SiteHeader() {
  ...
  return (
    <>
      <header
        className={`fixed inset-x-0 top-0 z-50 overflow-visible px-[var(--container-pad)] py-1.5 transition-[background-color,border-color,box-shadow] duration-300 md:py-2 ${headerShell}`}
      >
        <div className="pointer-events-auto flex flex-col gap-2 md:flex-row md:items-center md:justify-between md:gap-4">
          <div className="flex min-h-9 items-center justify-between gap-3 md:block md:shrink-0">
            <Link
              href={routes.home}
              className={`inline-flex shrink-0 items-center transition-opacity hover:opacity-90 ${brandClass}`}
            ...
            >
              <BrandLockup
                ...
                alt=""
                logoAppearance={
                  heroBarClear ? "over-video" : "on-light"
                }
              />
            </Link>
            <button
          ...
          <nav
            className="hidden flex-wrap items-center gap-x-5 gap-y-1 md:flex md:pt-px"
          ...
          <div className="hidden md:flex md:items-center md:pt-px">
            <div className="flex items-center gap-2 md:gap-3 lg:gap-4">
              <ThemeToggle heroBarClear={heroBarClear} />
              <div
              ...
              <a
                ...
                className={`inline-flex items-center gap-2 rounded-full border px-4 py-2 font-sans text-sm font-semibold leading-none tracking-wide shadow-sm transition ${
                  heroBarClear
      ...
      >
        ...
        <div className="mt-10 flex flex-col gap-4 border-t border-border pt-8">
          <ThemeToggle heroBarClear={false} className="self-start" />
